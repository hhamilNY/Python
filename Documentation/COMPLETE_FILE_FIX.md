# 🔧 Fix NameError: magnitudes not defined

## ❌ **Problem:**
The `create_magnitude_chart` function got corrupted in your Codespace file.

---

## 🛠️ **Complete Function Fix:**
...
### **Step 2: Find the broken function**
Press `Ctrl+W` and search for: `create_magnitude_chart`

### **Step 3: Replace the entire function**
Replace the broken `create_magnitude_chart` function with this complete, correct version:
...
## 🚀 **Alternative: Quick Recreation Method**

If the file is too corrupted, let's recreate it completely:

### **Step 1: Remove broken file**
```bash
rm mobile_earthquake_app.py
```
...
### **Step 3: Copy the complete working code**
I'll provide the entire working file content below.
...
**This complete file will fix all the errors!** 🌍